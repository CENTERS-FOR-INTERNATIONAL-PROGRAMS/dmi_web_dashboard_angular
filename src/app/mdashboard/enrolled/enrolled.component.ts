...
export class EnrolledComponent {
  ...
  enrollmentbygenderchartOptions: Highcharts.Options = {
...
enrollmentbyageandgenderchartOptions: Highcharts.Options = {

  title: {
    text: 'Enrolled by age & Gender',
    align: 'left',
},
...
enrollmentbyhealthfacilitiesrchartOptions: Highcharts.Options = {
...
enrollmentovertimechartOptions: Highcharts.Options = {
